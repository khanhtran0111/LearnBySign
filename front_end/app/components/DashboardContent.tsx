...
import { DashboardStats } from "./DashboardPage";
...
export function DashboardContent({ level, lessonGroups, onPlayLesson, stats }: DashboardContentProps) {
 const levelInfo = {
   newbie: {
     title: "Cấp độ Newbie",
 ...
 const currentLevelCompleted = levelStats?.completed || 0;
 const currentLevelTotal = levelStats?.total || 0;
 const currentLevelPercent = levelStats?.percent || 0;


 return (
   <div className="flex-1 overflow-y-auto bg-gradient-to-b from-white to-blue-50/30">
     <div className="p-8">
       {/* Header Section: Dùng data của Level hiện tại */}
       <div className="mb-8">
         ...
         <p className="text-muted-foreground">
            {/* Dùng data từ API*/}
           Hoàn thành {currentLevelCompleted}/{currentLevelTotal} bài học ({currentLevelPercent}%)
         </p>
       </div>


       {/* Stats Cards: Dùng data TỔNG QUÁT (Global Stats) */}
       <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
         {/* Card 1: Tổng tiến độ toàn khóa học */}
         <Card className="p-4 border-2">
           <div className="flex items-center gap-3">
             ...
             <div>
               ...
               <p className="text-2xl">{stats?.overallProgress || 0}%</p>
             </div>
           </div>
         </Card>


         {/* Card 2: Tổng số bài đã hoàn thành (tất cả levels) */}
         <Card className="p-4 border-2">
           <div className="flex items-center gap-3">
             ...
             <div>
               ...
               <p className="text-2xl">{stats?.totalCompleted || 0} bài</p>
             </div>
           </div>
         </Card>
         ...
         <Card className="p-4 border-2">
           <div className="flex items-center gap-3">
             ...
             <div>
               ...
               <p className="text-2xl">{stats?.streak || 0} ngày</p>
             </div>
           </div>
         </Card>
       </div>
